...
local Tabs = {
    ...
    Setting = Window:AddTab({ Title = "Cài bà đặt fram", Icon = "settings" }),
    ...
    Race = Window:AddTab({ Title = "Thức tỉnh V4", Icon = "chevrons-right" }),
    Shop = Window:AddTab({ Title = "Mua vật phẩm", Icon = "shopping-cart" }),
...
local listfastattack = {'Đánh thường','Đánh nhanh','Đánh siêu cấp nhanh'}

    local DropdownDelayAttack = Tabs.Main:AddDropdown("DropdownDelayAttack", {
        Title = "Chọn chế độ đánh nhanh",
    ...
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {Title = "Cày level cùng nhân", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Fram near / Mob Aura", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
--Mastery
local Mastery = Tabs.Main:AddSection("Cày mastery")
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Cày Cake Prince", Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {Title = "Giết boss", Default = false })
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "Auto cày vật liệu", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "Mua thuyền", Default = false })
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = "Cày terrororshark", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = "Giết cá Piranha", Default = false })
